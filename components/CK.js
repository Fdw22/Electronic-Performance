    ...
    return (
        <View style={styles.container,{flex: 1}}>
            <View style={{
                ...
                <Image source={require('../assets/png/support_flipped.png')}
                    style={{
                        alignItems:'center',
                        width:230,
                        height: 300,
