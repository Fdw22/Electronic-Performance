...
export default class CKK4 extends Component<Prop, State> {
    ...
    constructor(props){
        ...
        this.resK3 = Number(this.Calcutate3K1) + Number(this.Calcutate3K2);
    ...
    sendData = () => {
        this.props.navigation.navigate('RNPMK', {
            ...
            Calcutate3K1: this.Calcutate3K1,
            Calcutate3K2: this.Calcutate3K2,
            Calcutate3K3: this.Calcutate3K3,
            Calcutate3K4: this.Calcutate3K4,
            resK3: this.resK3,

            Calcutate4K1: this.state.Calcutate4K1,
            Calcutate4K2: this.state.Calcutate4K2,
            Calcutate4K3: this.state.Calcutate4K3,
            Calcutate4K4: this.state.Calcutate4K4,
            resK4: this.state.resK4,
        });
    }
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput 
                            ...
                            style={styles.input}
                            onChangeText={(text) => this.setState({Calcutate4K1: text})}
                            value={this.state.Calcutate4K1}
                        />
                        <TextInput 
                            placeholder="Total Penjualan" 
                            keyboardType='numeric'
                            style={styles.input}
                            onChangeText={(text) => this.setState({Calcutate4K2: text})}
                            value={this.state.Calcutate4K2}
                        />
                        <TextInput 
                            placeholder="Gross Margin" 
                            style={styles.input} 
                            keyboardType='numeric'
                            onChangeText={(text) => this.setState({Calcutate4K3: text})}
                            value={this.state.Calcutate4K3}
                        />
                        <TextInput 
                            placeholder="Total Aset"
                            keyboardType='numeric' 
                            style={styles.input}
                            onChangeText={(text) => this.setState({Calcutate4K4: text})}
                            value={this.state.Calcutate4K4}
                        />
                    </View>
