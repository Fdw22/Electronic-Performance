...
export default class RNPMI extends Component<Prop, State> {
                        ...
                        <View style={{
                            ...
                            <View style={styles.secondCircle}>
                                ...
                                <Text style ={{
                                    ...
                                    top:90,
                                    left:67,
                                }}>Merupakan rasio yang digunakan untuk mengukur tingkat keuntungan dari bisnis yang idjalankan oleh perusahaan. 
                                </Text>
