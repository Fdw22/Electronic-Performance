...
export default class RPAC2 extends Component<Prop, State> {
    C1A1: string;
    C1A2: string;
    resA1: string;
    ...
    sendData = () => {
        this.props.navigation.navigate('RPAC3',{
            ...
            C2A1: this.state.C2A1,
            C2A2: this.state.C2A2,
            resA2: this.state.resA2,
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput 
                            ...
                            style={styles.input}
                            onChangeText={(text) => this.setState({C2A1: text})}
                            value={this.state.C2A1}
                        />
                        <TextInput 
                            placeholder="Total Barang Cacat" 
                            style={styles.input}
                            keyboardType='numeric'
                            onChangeText={(text) => this.setState({C2A2: text})}
                            value={this.state.C2A2}
                        />
