...
export default class RPAC4 extends Component<Prop, State> {
    C1A1: string;
    C1A2: string;
    resA1: string;
    ...
    sendData = () => {
        this.props.navigation.navigate('RPARK',{
            C1A1: this.C1A1,
            C1A2: this.C1A2,
            resA1: this.resA1,
            ...
            C4A1: this.state.C4A1,
            C4A2: this.state.C4A2,
            resA4: this.state.resA4
        });
    }
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput 
                            ...
                            style={styles.input}
                            onChangeText={(text) => this.setState({C4A1: text})}
                            value={this.C4A1}
                        />
                        <TextInput 
                            ...
                            keyboardType='numeric' 
                            style={styles.input}
                            onChangeText={(text) => this.setState({C4A2: text})}
                            value={this.C4A2}
                        />
