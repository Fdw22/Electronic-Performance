...
export default class RPRK1 extends Component<Prop, State> {
    ...
    nextScreen = () => {
        this.props.navigation.navigate('RPRK2', {
            CR1K1: this.state.CR1K1,
            CR1K2: this.state.CR1K2,
            resCR1: this.state.resCR1,
        });
    }
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput 
                            ...
                            style={styles.input}
                            onChangeText={(text) => this.setState({CR1K1: text})}
                            value={this.state.CR1K1}
                        />
                        <TextInput 
                            placeholder="Total Barang Tanpa Cacat"
                            keyboardType='numeric' 
                            style={styles.input}
                            onChangeText={(text) => this.setState({CR1K2: text})}
                            value={this.state.CR1K2}
                        />
