...
export default class RPRK3 extends Component<Prop, State> {
    CR1K1: string;
    CR1K2: string;
    resCR1: string;
    ...
    sendData = () => {
        this.props.navigation.navigate('RPRK4',{
            CR1K1: this.CR1K1,
            CR1K2: this.CR1K2,
            resCR1: this.resCR1,
            ...
            CR3K1: this.state.CR3K1,
            CR3K2: this.state.CR3K2,
            resCR3: this.state.resCR3,
        });
    }
                ...
                <View style={styles.mainContainer}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput 
                            ...
                            onChangeText={(text) => this.setState({CR3K1: text})}
                            value={this.state.CR3K1}
                        />
                        <TextInput 
                            placeholder="Total Barang Tanpa Cacat" 
                            style={styles.input}
                            keyboardType='numeric'
                            onChangeText={(text) => this.setState({CR3K2: text})}
                            value={this.state.CR3K2}
                        />
